...
public class BlockCasting extends BlockInventory implements IFaucetDepth
{
    ...
    /* Bounds */
    private static final ImmutableList<AxisAlignedBB> BOUNDS_Table = ImmutableList.of(
    ...
    private static final ImmutableList<AxisAlignedBB> BOUNDS_Basin = ImmutableList.of(
