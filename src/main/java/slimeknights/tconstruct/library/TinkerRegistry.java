...
public final class TinkerRegistry
{
    ...
    | Smeltery                                                                  |
    ---------------------------------------------------------------------------*/
    private static final List<MeltingRecipe> meltingRegistry = Lists.newLinkedList();
    private static final List<ICastingRecipe> tableCastRegistry = Lists.newLinkedList();
    private static final List<ICastingRecipe> basinCastRegistry = Lists.newLinkedList();
    private static final List<AlloyRecipe> alloyRegistry = Lists.newLinkedList();
    private static final Map<FluidStack, Integer> smelteryFuels = Maps.newHashMap();
    private static final Map<ResourceLocation, FluidStack> entityMeltingRegistry = Maps.newHashMap();
    /*---------------------------------------------------------------------------
    | Drying Rack                                                               |
    ---------------------------------------------------------------------------*/
    private static final List<DryingRecipe> dryingRegistry = Lists.newLinkedList();
    /*---------------------------------------------------------------------------
