...
public class GuiUtil
{
    ...
    private static final Map<Fluid, List<FluidGuiEntry>> fluidGui = Maps.newHashMap();
    private static final boolean smelteryLoaded = TConstruct.pulseManager.isPulseLoaded(TinkerSmeltery.PulseId);
