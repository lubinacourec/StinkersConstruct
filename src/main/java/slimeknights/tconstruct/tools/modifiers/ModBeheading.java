...
public class ModBeheading extends ToolModifier
{
    ...
    private static final String BEHEADING_ID = "beheading";
    private static final String CLEAVER_MODIFIER_ID = BEHEADING_ID + "_cleaver";
    private static final int BEHEADING_COLOR = 0x10574b;
