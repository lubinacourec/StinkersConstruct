...
public class GuiInfoPanel extends GuiModule
{
    ...
    private static final ResourceLocation BACKGROUND = Util.getResource("textures/gui/panel.png");

    private static final GuiElement topLeft = new GuiElement(0, 0, 4, 4, 256, 256);
    private static final GuiElement topRight = new GuiElement(resW + 4, 0, 4, 4);
    private static final GuiElement botLeft = new GuiElement(0, resH + 4, 4, 4);
    private static final GuiElement botRight = new GuiElement(resW + 4, resH + 4, 4, 4);

    private static final GuiElementScalable top = new GuiElementScalable(4, 0, resW, 4);
    private static final GuiElementScalable bot = new GuiElementScalable(4, 4 + resH, resW, 4);
    private static final GuiElementScalable left = new GuiElementScalable(0, 4, 4, resH);
    private static final GuiElementScalable right = new GuiElementScalable(4 + resW, 4, 4, resH);

    private static final GuiElementScalable background = new GuiElementScalable(4, 4, resW, resH);

    private static final GuiElement sliderNormal = new GuiElement(0, 83, 3, 5);
    private static final GuiElement sliderHover = sliderNormal.shift(sliderNormal.w, 0);
